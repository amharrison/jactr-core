...
public class LispModelParser extends AbstractModelParser implements
    IModelParser
{
  /**
   * logger definition
  ...
  {
    LispParser parser = new LispParser(NULL_TOKEN_STREAM);
  ...
  {
    return ((LispParser) parser).model().tree;
  }

  /**
   * @see org.jactr.io.antlr3.parser.AbstractModelParser#postParse(org.antlr.runtime.Parser)
   */
}
