 ...
 * @author developer
 */
public class ConnectionAckHandler implements
    IMessageHandler<ControlAcknowledgement>
{

  private StateAndConnectionManager _manager;

  public ConnectionAckHandler(StateAndConnectionManager manager)
  {
    _manager = manager;
  }
  ...
  @Override
  public void accept(ISessionInfo<?> t, ControlAcknowledgement request)
  {
    _manager.participantState(t, request.getState());
  }
}
