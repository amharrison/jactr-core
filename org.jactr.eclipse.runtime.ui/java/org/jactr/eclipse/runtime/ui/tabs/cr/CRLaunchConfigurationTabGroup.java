...
import org.jactr.eclipse.runtime.ui.tabs.normal.RealityTab;
import org.jactr.eclipse.runtime.ui.tabs.normal.StartStopTab;

/**
 * @author harrison To change the template for this generated type comment go to
 *         Window - Preferences - Java - Code Generation - Code and Comments
 */
public class CRLaunchConfigurationTabGroup extends
    AbstractLaunchConfigurationTabGroup
{
  ...
  static private final transient Log LOGGER = LogFactory
                                                .getLog(CRLaunchConfigurationTabGroup.class);

  public void createTabs(ILaunchConfigurationDialog dialog, String mode)
  {
    Collection<AbstractLaunchConfigurationTab> options = new ArrayList<AbstractLaunchConfigurationTab>();

    // options.add(new ACTRMainTab());
    // options.add(new InstrumentsTab());
    options.add(new ProjectMainTab());
    options.add(new RealityTab());
    options.add(new StartStopTab());
    ...
    setTabs(options.toArray(new ILaunchConfigurationTab[0]));
  }
