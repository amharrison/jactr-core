...
public abstract class AbstractSimpleHorizontalASTView extends
    AbstractSessionTimeViewPart
{
  ...
  static private final transient Log LOGGER           = LogFactory
                                                          .getLog(AbstractSimpleHorizontalASTView.class);
  ...
  private Map<String, TableColumn>   _tableColumns;
  ...
  public AbstractSimpleHorizontalASTView()
  {
    super(true);
    _tableColumns = new TreeMap<String, TableColumn>();
  }
  ...
  public void createPartControl(Composite parent)
  {
    ...
    _table = new Table(composite, SWT.SINGLE | SWT.BORDER);
