 ...
 * @author harrison
 */
public abstract class AbstractParameterModifier
    implements IIterativeRunListener, IParameterized, IParameterModifier
{
  /**
   * Logger definition
   */
  ...
  public void setParameter(ICompilationUnit modelDescriptor,
      String parameterValue)
  {
    setParameter(modelDescriptor, _parameterName, parameterValue);
  }

  abstract protected void setParameter(ICompilationUnit modelDescriptor,
