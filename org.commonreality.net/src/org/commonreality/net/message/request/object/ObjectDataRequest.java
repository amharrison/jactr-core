    ...
    IObjectDataRequest
{
  ...
  /**
   * @see org.commonreality.net.message.request.object.IObjectDataRequest#getDestination()
   */
  ...
  /**
   * @see org.commonreality.net.message.request.object.IObjectDataRequest#getData()
   */
