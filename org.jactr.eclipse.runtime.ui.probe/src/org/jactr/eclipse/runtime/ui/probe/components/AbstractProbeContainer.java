...
public abstract class AbstractProbeContainer extends Canvas
{
  static final transient Log               LOGGER                 = LogFactory
                                                                      .getLog(AbstractProbeContainer.class);
  ...
  protected ModelProbeData                 _probeData;

  protected Map<String, Series>            _probeSeries;
  ...
  public AbstractProbeContainer(Composite parent, ModelProbeData mpd)
  {
    super(parent, SWT.BORDER_SOLID);

    _probeData = mpd;
    _probeSeries = new TreeMap<String, Series>();
  ...
  public ModelProbeData getProbeData()
  {
    return _probeData;
  }
  ...
  {
    return _probeData.getProbeNames(null);
  }
