...
public class JACTRDocumentProvider extends FileDocumentProvider
{

  IDocument document;

  // default documentProvider with modified createDocument()
  public JACTRDocumentProvider()
  {
    super();
  }
  ...
  protected IDocument createDocument(Object element) throws CoreException
  {
    ...
    IDocumentPartitioner partitioner = new FastPartitioner(
        JACTRPartitionScanner.getInstance(), JACTRPartitions.ALL_PARTITIONS);
