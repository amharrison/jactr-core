...
public class LispTemplateContext extends DocumentTemplateContext
{

  public LispTemplateContext(TemplateContextType type, IDocument document,
      ...
      throws BadLocationException, TemplateException
  {
    ...
    if (shouldFormat)
    {
//      JACTRFormattingStrategy format = new JACTRFormattingStrategy();
//      format.format(buffer, this, getDocument(), getStart());
    }
